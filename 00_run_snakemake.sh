...
snakemake \
   ...
   --set-resources ascp_ccs:runtime=360 ascp_ccs:mem=1G ascp_ccs:cpus_per_task=1 \
		   ...
		   seqkit_stats:runtime=360 seqkit_stats:mem=1G seqkit_stats:cpus_per_task=1 \
                   zcat_ccs:runtime=2280 zcat_ccs:mem=2T zcat_ccs:slurm_partition=himem zcat_ccs:cpus_per_task=1 \
		   jellyfish_count_ccs:runtime=4320 jellyfish_count_ccs:mem=3T jellyfish_count_ccs:cpus_per_task=6 jellyfish_count_ccs:slurm_partition=himem \
